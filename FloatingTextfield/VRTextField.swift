...
//
//
//  Created by vikram singh rajpoot on 10/04/17.
...
/*
 A Textfield class that can show floating place holder for the text field with bottom error message and different color codes.
 */
...
public class VRTextField: UITextField {
